...
const User = () => {
      ...
      <div className={classReader('col-12 col-sm-4')}>
        <div className={classReader('px-2')}>
          ...
          <Input
            name="email"
            register={register}
            validate={hookFormValidates().emailSearch}
  ...
  return (
    <>
      ...
      <UserDlg
        brandName={user.defaultProjectName}
  ...
  return <>
    ...
    >
      <div className={classReader('w-100')}>
        ...
        <div className={classReader('mb-4')}>{brandName}</div>
      </div>
...
export default User
User.layout = (page) => <Layout>{page}</Layout>